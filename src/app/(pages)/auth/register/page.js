  ...
  return (
    <div>
      <section className="bg-[url('/assets/img/auth/bg2.jpg')] relative  overflow-hidden  bg-cover h-screen ">
        <div className="bg-gradient-to-tl from-[#272A37] via-[#272A37] to-bl/70 w-full h-full">
          ...
          <div className="flex items-center flex-row-reverse h-screen px-10 font-poppins">
            ...
            <div className="flex absolute h-full -left-20 -top-[6px] justify-center w-full">
              <img src="/assets/img/auth/dot.svg" alt="" />
            </div>
            <img
              src="/assets/img/logo2.webp"
              className="absolute bottom-12 left-10 w-20"
              alt=""
            />
          </div>
        </div>
